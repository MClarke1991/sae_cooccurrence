...
def create_animated_plots(plot_data):
    ...
    pca_fig.data[0].visible = True
    bar_fig.data[0].visible = True
    ...
    for i in range(len(plot_data)):
        step = dict(
            method="update",
            args=[{"visible": [False] * len(pca_fig.data)},
...
def analyze_specific_points_animation(
    ...
    for i, point_id in enumerate(point_ids):
        ...
        bar_plot_data = df[['Feature Index', 'Activation']].to_dict('records')
